        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelStatusId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hotel_HotelStatus_HotelStatusId",
                        column: x => x.HotelStatusId,
                        principalTable: "HotelStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelUser", x => new { x.HotelId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "0ed899ae-5329-4bab-967b-a10130bb00bc", "Role", "Super Administrator", "SUPER ADMINISTRATOR" },
                    { 2, "2699c3af-735e-40e8-b43f-b880131c26cd", "Role", "Administrator", "ADMINISTRATOR" },
                    { 3, "a270f262-012d-47a4-aed2-1dbf5ef39b3f", "Role", "Hotel Manager", "HOTEL MANAGER" },
                    { 4, "6108e698-93ed-42f6-9736-51ddb80605b7", "Role", "Registered User", "REGISTERED USER" }
                });
