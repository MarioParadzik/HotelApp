...
namespace HotelApp.Api.DTO
{
    ...
    public class HotelRegistrationDtoValidator : AbstractValidator<HotelRegistrationDto>
    {
        public HotelRegistrationDtoValidator(ILocationRepository locationRepo)
        {
